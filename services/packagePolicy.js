...
const PACKAGE_POLICY_MAP = {
  10: {
    ...
    salesMatchNote: 'Bronze sales match is limited only by the pairing weekly cap (PHP 10,000) and monthly cap (PHP 40,000). Caps apply to Sales Match Bonus only — all other income still credits past the cap. No lifetime income ceiling.',
  },
  20: {
    packageType: 20,
    packageLabel: 'Silver',
    ...
    nextUpgradePackageType: 30,
    nextUpgradePackageLabel: 'Gold',
    salesMatchNote: 'Silver sales match is limited only by the pairing weekly cap (PHP 20,000) and monthly cap (PHP 80,000). Caps apply to Sales Match Bonus only — all other income still credits past the cap. No lifetime income ceiling.',
  },
  30: {
    packageType: 30,
    packageLabel: 'Gold',
