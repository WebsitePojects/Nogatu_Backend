...
const PACKAGE_POLICY_MAP = {
  10: {
    ...
    salesMatchNote: 'Bronze sales match follows the PPT safety net up to the 3rd level, with a PHP 40,000 lifetime ceiling across all credited income before upgrade is needed.',
  },
  20: {
    packageType: 20,
    packageLabel: 'Silver',
